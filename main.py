...
from data_processing_3 import CustomTensorDataset,dataProcessing_3
from trainer import FuseTrainer
if __name__ == '__main__':
    ...
    Train_P, Train_V, Train_Y,Val_P, Val_V, Val_Y,Test_P, Test_V, Test_Y=dataProcessing(file_path=r"D:\process date\2_S1")
    Train_V_std, Val_V_std, Test_V_std = standardize_with_train(Train_V,Val_V, Test_V)
    Train_P_std,Val_P_std, Test_P_std = standardize_with_train(Train_P,Val_P, Test_P)
    train_x, val_x, test_x, train_y, val_y, test_y = dataProcessing_3(file_path=r"D:\process date\1_S1")
    ...
    Val_x=np.concatenate((Val_P_std,Val_V_std,val_x),axis=2)
    ...
    model = FuseTrainer(args=args,label_names=["0","1","2","3","4","5","6","7","8"])
