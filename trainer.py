...
class FuseTrainer(pl.LightningModule):
    def __init__(self, args,label_names):
        super().__init__()
        self.model = FuseModel(hidden_size=args.hidden_size,num_classes=len(label_names))
        ...
        self.test_labels = []
        self.test_pairs = []
        self.test_feats = {k: [] for k in ['feat_vibration_shared', 'feat_vibration_distinct','feat_pressure_shared', 'feat_pressure_distinct','y_30','feat_final','pred_final1']}
        self.test_attns = []
    ...
    def pressure_pulsation_model(self, params, data):
        ...
        dict2 = {0: 147, 1: 294, 2: 437, 3: 581, 4: 732, 5: 880, 6: 1027, 7: 1180, 8: 1324}
